...
from transformers.models.olmo.modeling_olmo import OlmoDecoderLayer, OlmoLayerNorm
from transformers.models.olmo.modeling_olmo import OlmoDecoderLayer, OlmoLayerNorm
...
def apply_scale(module, scales_list, input_feat_dict=None):
    for prev_op_name, layer_names, scales in scales_list:
        ...
        if isinstance(prev_op, nn.Linear):
            ...
            for layer in layers:
                s = scales.view(1, -1).to(layer.weight.device).to(layer.weight.dtype)
                layer.weight.data.mul_(s)
