...
def evaluate_boolq(model, tokenizer, limit=20, device="cuda:0"):
...
if __name__ == "__main__":
    ...
    output_json = Path("gptq_olmo1b_boolq.json")
    ...
    acc, results = evaluate_boolq(model, tokenizer, limit=limit, device=DEV)
