...
def llama_sequential(model, dataloader, dev):
    ...
    # Newer transformers versions may keep rotary buffers on CPU unless forced.
    if hasattr(model.model, "rotary_emb") and model.model.rotary_emb is not None:
        model.model.rotary_emb = model.model.rotary_emb.to(dev)
        if hasattr(model.model.rotary_emb, "inv_freq") and model.model.rotary_emb.inv_freq is not None:
            model.model.rotary_emb.inv_freq = model.model.rotary_emb.inv_freq.to(dev)
        if hasattr(model.model.rotary_emb, "original_inv_freq") and model.model.rotary_emb.original_inv_freq is not None:
            model.model.rotary_emb.original_inv_freq = model.model.rotary_emb.original_inv_freq.to(dev)
