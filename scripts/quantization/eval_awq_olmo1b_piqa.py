...
def main():
    ...
    parser.add_argument("--output-json", default="results/quantization/olmo1b/awq_w4/piqa.json")
    ...
    for ex in tqdm(ds, desc="Evaluating PIQA"):
        ...
        score1 = score_continuation(model, tokenizer, prompt, " " + ex["sol1"].strip())
        score2 = score_continuation(model, tokenizer, prompt, " " + ex["sol2"].strip())
